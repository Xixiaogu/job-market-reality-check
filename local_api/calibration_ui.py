...
<div class="shell">
  ...
  <div class="notice"><strong>说明：</strong>页面中的“匹配代理值”和“机会代理值”只用于挑选不同类型的样本，不是最终投递评分。人工标注完成后，系统会用这些判断检查并校准投递评分。</div>
  ...
  <div id="complete" class="complete">10个代表岗位已经全部完成标注，系统现在可以使用这组判断进行校准。</div>
</div>
<script>
(()=>{'use strict';
